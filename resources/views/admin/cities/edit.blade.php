...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Update city name and location.</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.cities.update', $city) }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="province" class="form-control" value="{{ old('province', $city->province) }}">
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="city-latitude" type="text" name="latitude" class="form-control" value="{{ old('latitude', $city->latitude) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Longitude</label>
                        <input id="city-longitude" type="text" name="longitude" class="form-control" value="{{ old('longitude', $city->longitude) }}">
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-check mt-3">
                            <input class="form-check-input" type="checkbox" name="is_active" id="city-is-active" {{ $city->is_active ? 'checked' : '' }}>
